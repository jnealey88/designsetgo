<?php
/**
 * Title: Portfolio Personal Hero
 * Slug: designsetgo/hero/hero-portfolio-personal
 * Categories: dsgo-hero
 * Description: A two-column personal portfolio hero with designer introduction, bio, skills, and profile image
 * Keywords: hero, portfolio, personal, designer, creative, introduction
 */

defined( 'ABSPATH' ) || exit;

return array(
	'title'      => __( 'Portfolio Personal Hero', 'designsetgo' ),
