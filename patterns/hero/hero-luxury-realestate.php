 ...
 * Slug: designsetgo/hero/hero-luxury-realestate
 * Categories: dsgo-hero
 * Description: An elegant hero section for luxury real estate with refined headline, description, and property search CTAs
 * Keywords: hero, luxury, real estate, property, elegant, upscale
 */

defined( 'ABSPATH' ) || exit;

return array(
	'title'      => __( 'Luxury Real Estate Hero', 'designsetgo' ),
	'categories' => array( 'dsgo-hero' ),
	'viewportWidth' => 1200,
	'content'    => '<!-- wp:designsetgo/section {"style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"}}},"dsgoAnimationEnabled":true,"dsgoEntranceAnimation":"fadeIn","dsgoAnimationDuration":1000} -->
