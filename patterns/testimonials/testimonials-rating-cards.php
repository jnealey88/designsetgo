 ...
 * Slug: designsetgo/testimonials/testimonials-rating-cards
 * Categories: dsgo-testimonials
 * Description: Customer testimonials with star ratings in cards
 * Keywords: testimonials, ratings, stars, reviews, customers
 */

defined( 'ABSPATH' ) || exit;

return array(
	'title'      => __( 'Testimonials with Star Ratings', 'designsetgo' ),
	'categories' => array( 'dsgo-testimonials' ),
	'viewportWidth' => 1200,
	'content'    => '<!-- wp:designsetgo/section {"style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70","left":"var:preset|spacing|30","right":"var:preset|spacing|30"}}},"backgroundColor":"base","metadata":{"categories":["dsgo-testimonials"],"patternName":"designsetgo/testimonials/testimonials-rating-cards","name":"Testimonials with Star Ratings"}} -->
...
<p class="has-text-align-center has-medium-font-size">Real reviews from real customers</p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:designsetgo/section -->

<!-- wp:designsetgo/grid {"style":{"spacing":{"blockGap":"var:preset|spacing|40","padding":{"top":"0","bottom":"0","left":"0","right":"0"}}}} -->
<div class="wp-block-designsetgo-grid alignfull dsgo-grid dsgo-grid-cols-3 dsgo-grid-cols-tablet-2 dsgo-grid-cols-mobile-1 dsgo-no-width-constraint" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><div class="dsgo-grid__inner" style="display:grid;grid-template-columns:repeat(3, 1fr);align-items:stretch;row-gap:var(--wp--preset--spacing--40);column-gap:var(--wp--preset--spacing--40)"><!-- wp:designsetgo/section {"constrainWidth":false,"style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40","left":"var:preset|spacing|40","right":"var:preset|spacing|40"}},"border":{"radius":"16px","width":"1px","color":"#e2e8f0"}},"className":"has-dsgo-animation dsgo-animation-fadeInUp","dsgoAnimationEnabled":true,"dsgoEntranceAnimation":"fadeInUp","dsgoAnimationDuration":600,"backgroundColor":"base"} -->
<div class="wp-block-designsetgo-section alignfull dsgo-stack dsgo-no-width-constraint has-dsgo-animation dsgo-animation-fadeInUp has-border-color has-base-background-color has-background" style="border-color:#e2e8f0;border-width:1px;border-radius:16px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)" data-dsgo-animation-enabled="true" data-dsgo-entrance-animation="fadeInUp" data-dsgo-exit-animation="" data-dsgo-animation-trigger="scroll" data-dsgo-animation-duration="600" data-dsgo-animation-delay="0" data-dsgo-animation-easing="ease-out" data-dsgo-animation-offset="100" data-dsgo-animation-once="true"><div class="dsgo-stack__inner"><!-- wp:designsetgo/row {"style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"},"margin":{"bottom":"var:preset|spacing|20"},"blockGap":"var:preset|spacing|20"}}} -->
<div class="wp-block-designsetgo-row alignfull dsgo-flex dsgo-no-width-constraint" style="margin-bottom:var(--wp--preset--spacing--20);padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><div class="dsgo-flex__inner" style="display:flex;justify-content:left;flex-wrap:wrap;gap:var(--wp--preset--spacing--20)"><!-- wp:designsetgo/icon {"iconSize":24,"className":"dsgo-lazy-icon","style":{"spacing":{"padding":{"top":"0","bottom":"0"}}}} -->
<div class="wp-block-designsetgo-icon dsgo-icon dsgo-lazy-icon" style="padding-top:0;padding-bottom:0;display:flex;align-items:center;justify-content:center"><div class="dsgo-icon__wrapper dsgo-lazy-icon" style="width:24px;height:24px;display:inline-flex;align-items:center;justify-content:center;border-radius:inherit" data-icon-name="star" data-icon-style="filled" data-icon-stroke-width="1.5" role="img" aria-label="Star"></div></div>
<!-- /wp:designsetgo/icon -->

<!-- wp:designsetgo/icon {"iconSize":24,"className":"dsgo-lazy-icon","style":{"spacing":{"padding":{"top":"0","bottom":"0"}}}} -->
<div class="wp-block-designsetgo-icon dsgo-icon dsgo-lazy-icon" style="padding-top:0;padding-bottom:0;display:flex;align-items:center;justify-content:center"><div class="dsgo-icon__wrapper dsgo-lazy-icon" style="width:24px;height:24px;display:inline-flex;align-items:center;justify-content:center;border-radius:inherit" data-icon-name="star" data-icon-style="filled" data-icon-stroke-width="1.5" role="img" aria-label="Star"></div></div>
<!-- /wp:designsetgo/icon -->

<!-- wp:designsetgo/icon {"iconSize":24,"className":"dsgo-lazy-icon"} -->
<div class="wp-block-designsetgo-icon dsgo-icon dsgo-lazy-icon" style="display:flex;align-items:center;justify-content:center"><div class="dsgo-icon__wrapper dsgo-lazy-icon" style="width:24px;height:24px;display:inline-flex;align-items:center;justify-content:center;border-radius:inherit" data-icon-name="star" data-icon-style="filled" data-icon-stroke-width="1.5" role="img" aria-label="Star"></div></div>
<!-- /wp:designsetgo/icon -->
