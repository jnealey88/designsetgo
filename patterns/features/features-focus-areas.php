<?php
/**
 * Title: Focus Areas Grid
 * Slug: designsetgo/features/features-focus-areas
 * Categories: dsgo-features
 * Description: A four-column grid of focus area cards with icons showing key areas of nonprofit work
 * Keywords: features, focus areas, nonprofit, charity, causes, grid
 */

defined( 'ABSPATH' ) || exit;

return array(
	'title'      => __( 'Focus Areas Grid', 'designsetgo' ),
	'categories' => array( 'dsgo-features' ),
	'viewportWidth' => 1200,
	'content'    => '<!-- wp:designsetgo/section {"style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"var:preset|spacing|30","right":"var:preset|spacing|30"}}},"backgroundColor":"base-2","metadata":{"categories":["dsgo-features"],"patternName":"designsetgo/features/features-focus-areas","name":"Focus Areas Grid"}} -->
