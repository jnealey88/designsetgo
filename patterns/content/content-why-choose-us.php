 ...
 * Slug: designsetgo/content/content-why-choose-us
 * Categories: dsgo-content
 * Description: A two-column section highlighting reasons to choose a firm with icon list and supporting image
 * Keywords: why choose, benefits, trust, professional, firm, reasons
 */

defined( 'ABSPATH' ) || exit;

return array(
	'title'      => __( 'Why Choose Us Section', 'designsetgo' ),
	'categories' => array( 'dsgo-content' ),
	'viewportWidth' => 1200,
	'content'    => '<!-- wp:designsetgo/section {"style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"var:preset|spacing|30","right":"var:preset|spacing|30"}}},"backgroundColor":"base-2","metadata":{"categories":["dsgo-content"],"patternName":"designsetgo/content/content-why-choose-us","name":"Why Choose Us Section"}} -->
...
<div class="wp-block-designsetgo-row alignfull dsgo-flex dsgo-no-width-constraint" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><div class="dsgo-flex__inner" style="display:flex;justify-content:left;align-items:flex-start;flex-wrap:nowrap"><!-- wp:designsetgo/icon {"icon":"verified-check"} -->
