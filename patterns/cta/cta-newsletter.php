...
return array(
	...
	'content'    => '<!-- wp:designsetgo/section {"style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60"}}},"className":"has-dsgo-animation dsgo-animation-fadeIn","backgroundColor":"base-2","metadata":{"categories":["dsgo-cta"],"patternName":"designsetgo/cta/cta-newsletter","name":"Newsletter Signup"}} -->
