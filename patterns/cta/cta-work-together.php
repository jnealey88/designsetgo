<?php
/**
 * Title: Work Together CTA
 * Slug: designsetgo/cta/cta-work-together
 * Categories: dsgo-cta
 * Description: A centered call-to-action for collaboration with email link and social media icons
 * Keywords: cta, collaboration, work together, contact, portfolio, freelancer
 */

defined( 'ABSPATH' ) || exit;

return array(
	'title'      => __( 'Work Together CTA', 'designsetgo' ),
