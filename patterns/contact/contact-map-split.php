...
<p class="has-text-align-center has-text-color has-medium-font-size" style="color:#64748b;margin-top:var(--wp--preset--spacing--20)">Have a question or want to work together? We\'d love to hear from you.</p>
...
<!-- wp:designsetgo/form-textarea-field {"fieldName":"contact_message","label":"Message","placeholder":"Tell us about your project...","required":true,"rows":5} -->
<div class="wp-block-designsetgo-form-textarea-field dsgo-form-field dsgo-form-field--textarea" style="flex-basis:100%;max-width:100%"><label for="field-contact_message" class="dsgo-form-field__label">Message<span class="dsgo-form-field__required" aria-label="required">*</span></label><textarea id="field-contact_message" name="contact_message" class="dsgo-form-field__textarea" placeholder="Tell us about your project..." rows="5" required aria-required="true" data-field-type="textarea"></textarea></div>
<!-- /wp:designsetgo/form-textarea-field --></div><input type="text" name="dsg_website" value="" tabindex="-1" autocomplete="off" aria-hidden="true" style="position:absolute;left:-9999px;width:1px;height:1px;overflow:hidden"/><input type="hidden" name="dsg_form_id" value="contact-map-form"/><div class="dsgo-form__footer"><button type="submit" class="dsgo-form__submit wp-element-button" style="min-height:44px;padding-top:0.75rem;padding-bottom:0.75rem;padding-left:2rem;padding-right:2rem;background-color:#6366f1;color:#ffffff;border-radius:8px">Send Message</button></div><div class="dsgo-form__message" role="status" aria-live="polite" aria-atomic="true" style="display:none"></div></form></div>
...
<div class="wp-block-designsetgo-section alignfull dsgo-stack has-dsgo-animation dsgo-animation-fadeInRight" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0" data-dsgo-animation-enabled="true" data-dsgo-entrance-animation="fadeInRight" data-dsgo-exit-animation="" data-dsgo-animation-trigger="scroll" data-dsgo-animation-duration="600" data-dsgo-animation-delay="0" data-dsgo-animation-easing="ease-out" data-dsgo-animation-offset="100" data-dsgo-animation-once="true"><div class="dsgo-stack__inner" style="max-width:var(--wp--style--global--content-size, 1140px);margin-left:auto;margin-right:auto"><!-- wp:designsetgo/map {"height":"300px","style":{"border":{"radius":"16px 16px 0 0"}},"zoom":14,"latitude":40.7128,"longitude":-74.0060,"markerTitle":"Our Office"} -->
<div class="wp-block-designsetgo-map dsgo-map" style="height:300px;border-radius:16px 16px 0 0" data-provider="openstreetmap" data-latitude="40.7128" data-longitude="-74.0060" data-zoom="14" data-marker-title="Our Office" data-show-marker="true"><div class="dsgo-map__container"></div></div>
<!-- /wp:designsetgo/map -->

<!-- wp:designsetgo/section {"style":{"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30","left":"var:preset|spacing|30","right":"var:preset|spacing|30"}},"border":{"radius":"0 0 16px 16px"}},"backgroundColor":"base"} -->
...
<div class="wp-block-designsetgo-section alignfull dsgo-stack" style="margin-bottom:var(--wp--preset--spacing--20);padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><div class="dsgo-stack__inner" style="max-width:var(--wp--style--global--content-size, 1140px);margin-left:auto;margin-right:auto"><!-- wp:designsetgo/row {"style":{"spacing":{"blockGap":"var:preset|spacing|15","padding":{"top":"0","bottom":"0","left":"0","right":"0"}}},"layout":{"type":"flex","justifyContent":"left","flexWrap":"nowrap"}} -->
<div class="wp-block-designsetgo-row alignfull dsgo-flex dsgo-no-width-constraint" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><div class="dsgo-flex__inner" style="display:flex;justify-content:left;flex-wrap:nowrap;gap:var(--wp--preset--spacing--15)"><!-- wp:designsetgo/icon {"icon":"phone","iconSize":20,"style":{"color":{"text":"#6366f1"}}} -->
...
<!-- wp:designsetgo/section {"style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"},"margin":{"bottom":"var:preset|spacing|20"}}}} -->
<div class="wp-block-designsetgo-section alignfull dsgo-stack" style="margin-bottom:var(--wp--preset--spacing--20);padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><div class="dsgo-stack__inner" style="max-width:var(--wp--style--global--content-size, 1140px);margin-left:auto;margin-right:auto"><!-- wp:designsetgo/row {"style":{"spacing":{"blockGap":"var:preset|spacing|15","padding":{"top":"0","bottom":"0","left":"0","right":"0"}}},"layout":{"type":"flex","justifyContent":"left","flexWrap":"nowrap"}} -->
<div class="wp-block-designsetgo-row alignfull dsgo-flex dsgo-no-width-constraint" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><div class="dsgo-flex__inner" style="display:flex;justify-content:left;flex-wrap:nowrap;gap:var(--wp--preset--spacing--15)"><!-- wp:designsetgo/icon {"icon":"mail","iconSize":20,"style":{"color":{"text":"#6366f1"}}} -->
...
<div class="wp-block-designsetgo-row alignfull dsgo-flex dsgo-no-width-constraint" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><div class="dsgo-flex__inner" style="display:flex;justify-content:left;flex-wrap:nowrap;gap:var(--wp--preset--spacing--15)"><!-- wp:designsetgo/icon {"icon":"clock","iconSize":20,"style":{"color":{"text":"#6366f1"}}} -->
