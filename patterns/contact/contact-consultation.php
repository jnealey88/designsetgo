...
return array(
	...
	'viewportWidth' => 1200,
	'content'    => '<!-- wp:designsetgo/section {"style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"var:preset|spacing|30","right":"var:preset|spacing|30"}}},"backgroundColor":"contrast","textColor":"base","metadata":{"categories":["dsgo-contact"],"patternName":"designsetgo/contact/contact-consultation","name":"Consultation Contact Section"}} -->
...
<!-- wp:designsetgo/form-textarea-field {"fieldName":"field_79b62438","label":"Brief Description of Your Matter","placeholder":"Please briefly describe how we can help you...","className":"wp-block-designsetgo-form-textarea"} -->
<div class="wp-block-designsetgo-form-textarea-field dsgo-form-field dsgo-form-field--textarea wp-block-designsetgo-form-textarea" style="flex-basis:100%;max-width:100%"><label for="field-field_79b62438" class="dsgo-form-field__label">Brief Description of Your Matter</label><textarea id="field-field_79b62438" name="field_79b62438" class="dsgo-form-field__textarea" placeholder="Please briefly describe how we can help you..." rows="4" data-field-type="textarea"></textarea></div>
