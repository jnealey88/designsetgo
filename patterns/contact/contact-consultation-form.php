<?php
/**
 * Title: Consultation Contact Form
 * Slug: designsetgo/contact/contact-consultation-form
 * Categories: dsgo-contact
 * Description: A two-column contact section with consultation heading and form fields alongside contact information
 * Keywords: contact, consultation, form, real estate, luxury, schedule
 */

defined( 'ABSPATH' ) || exit;

return array(
	'title'      => __( 'Consultation Contact Form', 'designsetgo' ),
	'categories' => array( 'dsgo-contact' ),
	'viewportWidth' => 1200,
	'content'    => '<!-- wp:designsetgo/section {"style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"var:preset|spacing|30","right":"var:preset|spacing|30"}}},"shapeDividerTop":"wave","shapeDividerTopHeight":80,"shapeDividerTopFlipY":true,"backgroundColor":"contrast","textColor":"base","metadata":{"categories":["dsgo-contact"],"patternName":"designsetgo/contact/contact-consultation-form","name":"Consultation Contact Form"}} -->
...
<!-- wp:designsetgo/form-phone-field {"fieldName":"phone-b654a39d","placeholder":"000-123-4567"} -->
<div class="wp-block-designsetgo-form-phone-field dsgo-form-field dsgo-form-field--phone" style="flex-basis:100%;max-width:100%"><label for="field-phone-b654a39d" class="dsgo-form-field__label">Phone Number</label><div class="dsgo-form-field__phone-wrapper" style="display:flex;gap:0.5rem" data-auto-format="true"><select name="phone-b654a39d_country_code" class="dsgo-form-field__country-code" defaultvalue="+1" style="min-width:85px;flex-shrink:0" aria-label="Country Code"><option value="+1">+1 (US/Canada)</option><option value="+44">+44 (UK)</option><option value="+61">+61 (Australia)</option><option value="+33">+33 (France)</option><option value="+49">+49 (Germany)</option><option value="+81">+81 (Japan)</option><option value="+86">+86 (China)</option><option value="+91">+91 (India)</option><option value="+7">+7 (Russia)</option><option value="+34">+34 (Spain)</option><option value="+39">+39 (Italy)</option><option value="+52">+52 (Mexico)</option><option value="+55">+55 (Brazil)</option></select><input type="tel" id="field-phone-b654a39d" name="phone-b654a39d" class="dsgo-form-field__input" placeholder="000-123-4567" data-field-type="tel" data-phone-format="any" style="flex:1px"/></div></div>
