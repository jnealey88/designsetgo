<?php
/**
 * Title: Event Ticket Pricing
 * Slug: designsetgo/pricing/pricing-event-tickets
 * Categories: dsgo-pricing
 * Description: A three-tier event ticket pricing section with General, VIP, and Corporate pass options and feature lists
 * Keywords: pricing, tickets, event, conference, pass, tiers
 */

defined( 'ABSPATH' ) || exit;

return array(
	'title'      => __( 'Event Ticket Pricing', 'designsetgo' ),
