 ...
 * Slug: designsetgo/pricing/pricing-saas-plans
 * Categories: dsgo-pricing
 * Description: A three-tier SaaS pricing section with Starter, Pro, and Enterprise plans with feature comparisons
 * Keywords: pricing, saas, plans, tiers, software, subscription
 */

defined( 'ABSPATH' ) || exit;

return array(
	'title'      => __( 'SaaS Pricing Plans', 'designsetgo' ),
	'categories' => array( 'dsgo-pricing' ),
	'viewportWidth' => 1200,
	'content'    => '<!-- wp:designsetgo/section {"style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"var:preset|spacing|30","right":"var:preset|spacing|30"}}},"backgroundColor":"base-2","dsgoAnimationEnabled":true,"dsgoEntranceAnimation":"fadeIn"} -->
