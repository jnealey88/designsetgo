...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--xl);padding-bottom:var(--wp--preset--spacing--xl)">
	...
	<div class="wp-block-designsetgo-accordion dsg-accordion dsg-accordion--icon-right dsg-accordion--border-between" data-allow-multiple="false" data-icon-style="chevron">
		<div class="dsg-accordion__items">
			<!-- wp:designsetgo/accordion-item {"title":"What is DesignSetGo?","isOpen":true} -->
			<div class="wp-block-designsetgo-accordion-item dsg-accordion-item dsg-accordion-item--open" data-initially-open="true">
				<div class="dsg-accordion-item__header">
					<button type="button" class="dsg-accordion-item__trigger dsg-accordion-item__trigger--icon-right" aria-expanded="true">
						<span class="dsg-accordion-item__title">What is DesignSetGo?</span>
						<span class="dsg-accordion-item__icon" aria-hidden="true">
				...
				<div class="dsg-accordion-item__panel" role="region">
					<div class="dsg-accordion-item__content">
						<!-- wp:paragraph -->
			...
			<div class="wp-block-designsetgo-accordion-item dsg-accordion-item dsg-accordion-item--closed" data-initially-open="false">
				<div class="dsg-accordion-item__header">
					<button type="button" class="dsg-accordion-item__trigger dsg-accordion-item__trigger--icon-right" aria-expanded="false">
						<span class="dsg-accordion-item__title">How do I use the Accordion block?</span>
						<span class="dsg-accordion-item__icon" aria-hidden="true">
							<svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor"><path d="M4.427 6.427l3.396 3.396a.25.25 0 00.354 0l3.396-3.396A.25.25 0 0011.396 6H4.604a.25.25 0 00-.177.427z"></path></svg>
						</span>
					</button>
				</div>
				<div class="dsg-accordion-item__panel" role="region" hidden>
					<div class="dsg-accordion-item__content">
						<!-- wp:paragraph -->
			...
			<div class="wp-block-designsetgo-accordion-item dsg-accordion-item dsg-accordion-item--closed" data-initially-open="false">
				<div class="dsg-accordion-item__header">
					<button type="button" class="dsg-accordion-item__trigger dsg-accordion-item__trigger--icon-right" aria-expanded="false">
						<span class="dsg-accordion-item__title">Can I customize the accordion appearance?</span>
						<span class="dsg-accordion-item__icon" aria-hidden="true">
							<svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor"><path d="M4.427 6.427l3.396 3.396a.25.25 0 00.354 0l3.396-3.396A.25.25 0 0011.396 6H4.604a.25.25 0 00-.177.427z"></path></svg>
						</span>
					</button>
			...
			<div class="wp-block-designsetgo-accordion-item dsg-accordion-item dsg-accordion-item--closed" data-initially-open="false">
				<div class="dsg-accordion-item__header">
					<button type="button" class="dsg-accordion-item__trigger dsg-accordion-item__trigger--icon-right" aria-expanded="false">
						<span class="dsg-accordion-item__title">Is the accordion accessible?</span>
						<span class="dsg-accordion-item__icon" aria-hidden="true">
							<svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor"><path d="M4.427 6.427l3.396 3.396a.25.25 0 00.354 0l3.396-3.396A.25.25 0 0011.396 6H4.604a.25.25 0 00-.177.427z"></path></svg>
						</span>
					</button>
