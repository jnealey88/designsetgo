 ...
 *
 * Configures DesignSetGo form builder blocks using schema derived from block.json.
 *
 * @package DesignSetGo
 ...
 */
class Configure_Form_Builder extends Abstract_Configurator_Ability {
	...
	public function get_name(): string {
		return 'designsetgo/configure-form-builder';
	}
	...
	protected function get_target_block_name(): ?string {
		return 'designsetgo/form-builder';
	}
