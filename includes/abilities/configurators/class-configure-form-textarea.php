 ...
 *
 * Configures DesignSetGo form textarea blocks using schema derived from block.json.
 *
 * @package DesignSetGo
 ...
 */
class Configure_Form_Textarea extends Abstract_Configurator_Ability {
	...
	public function get_name(): string {
		return 'designsetgo/configure-form-textarea';
	}
	...
	protected function get_target_block_name(): ?string {
		return 'designsetgo/form-textarea';
	}
