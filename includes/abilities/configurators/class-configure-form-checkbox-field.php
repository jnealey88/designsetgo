 ...
 *
 * Configures DesignSetGo form checkbox field blocks using schema derived from block.json.
 *
 * @package DesignSetGo
 ...
 */
class Configure_Form_Checkbox_Field extends Abstract_Configurator_Ability {
	...
	public function get_name(): string {
		return 'designsetgo/configure-form-checkbox-field';
	}
	...
	protected function get_target_block_name(): ?string {
		return 'designsetgo/form-checkbox-field';
	}
