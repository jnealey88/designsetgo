	...
	return (
		...
		>
			<ToggleControl
				...
				help={__('Hide this container on desktop screens (>1024px)', 'designsetgo')}
			/>
			...
			<ToggleControl
				...
				help={__('Hide this container on tablet screens (768px-1023px)', 'designsetgo')}
			/>
			...
			<ToggleControl
				...
				help={__('Hide this container on mobile screens (<768px)', 'designsetgo')}
			/>
		</PanelBody>
	);
};
