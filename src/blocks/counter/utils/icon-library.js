/**
 * Counter Block - Icon Library
 *
 * SVG icons for counter block.
...
/**
 * Get SVG element for specified icon.
 *
 * @param {string} iconName - Icon name (star, trophy, heart, check, dollar, users, chart, rocket)
