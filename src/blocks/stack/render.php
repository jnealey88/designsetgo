<?php
/**
 * Stack Container Block - Server-side Render
 *
 * Dynamically renders the Stack block using get_block_wrapper_attributes().
...
<div <?php echo $wrapper_attributes; ?>>
	<div class="dsg-stack__inner" style="<?php echo $inner_style_string; ?>">
		<?php echo $content; ?>
	</div>
</div>
