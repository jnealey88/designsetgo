    ...
    useEffect(() => {
        const scanEditorHeadings = () => {
            try {
                ...
                if (levelFlags.includeH2) levels.push('h2');
                if (levelFlags.includeH3) levels.push('h3');
                if (levelFlags.includeH4) levels.push('h4');
                if (levelFlags.includeH5) levels.push('h5');
                if (levelFlags.includeH6) levels.push('h6');
