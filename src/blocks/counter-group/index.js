	...
	icon: {
		src: (
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
				...
				<text x="6.5" y="8" fontSize="6" fontWeight="bold" textAnchor="middle" stroke="none" fill="currentColor">1</text>
				<text x="16.5" y="8" fontSize="6" fontWeight="bold" textAnchor="middle" stroke="none" fill="currentColor">2</text>
				<text x="6.5" y="18" fontSize="6" fontWeight="bold" textAnchor="middle" stroke="none" fill="currentColor">3</text>
				<text x="16.5" y="18" fontSize="6" fontWeight="bold" textAnchor="middle" stroke="none" fill="currentColor">4</text>
			</svg>
		),
		foreground: '#2563eb',
	},
