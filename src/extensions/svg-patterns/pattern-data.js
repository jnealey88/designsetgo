 ...
 * - category: Category key for grouping in the picker
...
export const PATTERNS = {
	...
	'cross-grid': {
		label: __('Cross Grid', 'designsetgo'),
		category: 'minimal',
		width: 24,
		height: 24,
		paths: [
	...
	'diagonal-lines': {
		label: __('Diagonal Lines', 'designsetgo'),
		category: 'minimal',
		width: 6,
		height: 6,
		paths: [
	...
	'horizontal-lines': {
		label: __('Horizontal Lines', 'designsetgo'),
		category: 'minimal',
		width: 24,
		height: 24,
		paths: [
	...
	'diagonal-stripes': {
		label: __('Diagonal Stripes', 'designsetgo'),
		category: 'minimal',
		width: 40,
		height: 40,
		paths: [
	...
	'diamond-grid': {
		label: __('Diamond Grid', 'designsetgo'),
		category: 'geometric',
		width: 20,
		height: 20,
		paths: [
	...
	'flipped-diamonds': {
		label: __('Flipped Diamonds', 'designsetgo'),
		category: 'geometric',
		width: 16,
		height: 32,
		paths: [
	...
	'triangle-grid': {
		label: __('Triangle Grid', 'designsetgo'),
		category: 'geometric',
		width: 40,
		height: 40,
		paths: [
	...
	topography: {
		label: __('Topography', 'designsetgo'),
		category: 'organic',
		width: 600,
		height: 600,
		paths: [
	...
	crosshatch: {
		label: __('Crosshatch', 'designsetgo'),
		category: 'texture',
		width: 8,
		height: 8,
		paths: [
	...
	'stacked-arcs': {
		label: __('Stacked Arcs', 'designsetgo'),
		category: 'depth',
		width: 40,
		height: 40,
		paths: [
	...
	'circuit-board': {
		label: __('Circuit Board', 'designsetgo'),
		category: 'technical',
		width: 304,
		height: 304,
		paths: [
	...
	'graph-paper': {
		label: __('Graph Paper', 'designsetgo'),
		category: 'technical',
		width: 40,
		height: 40,
		paths: [
...
export const CATEGORIES = {
	minimal: __('Minimal', 'designsetgo'),
	geometric: __('Geometric', 'designsetgo'),
	organic: __('Organic', 'designsetgo'),
	texture: __('Texture', 'designsetgo'),
	depth: __('Depth', 'designsetgo'),
	technical: __('Technical', 'designsetgo'),
};
